...
#import the csv file
df = pd.read_csv('FinalProject\Police_Department_Incidents_-_Previous_Year__2016_.csv')
...
train_data.to_csv("FinalProject\\TrainData.csv", index=False)
test_data.to_csv("FinalProject\\TestData.csv", index=False)
